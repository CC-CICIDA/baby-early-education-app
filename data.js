const educationData = {
    "0-1": {
        recipes: [
            { day: "周一", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=breastfeeding%20newborn%20baby&image_size=portrait_4_3", tips: "按需喂养，每次15-30分钟", ai_review: "已审核-符合权威喂养指南" },
            { day: "周二", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20bottle%20feeding%20formula&image_size=portrait_4_3", tips: "配方奶水温40-50度", ai_review: "已审核-符合权威喂养指南" },
            { day: "周三", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=mother%20breastfeeding%20baby%20calm&image_size=portrait_4_3", tips: "喂奶后竖抱拍嗝", ai_review: "已审核-符合权威喂养指南" },
            { day: "周四", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=infant%20feeding%20time%20peaceful&image_size=portrait_4_3", tips: "保持安静的喂养环境", ai_review: "已审核-符合权威喂养指南" },
            { day: "周五", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20drinking%20milk%20happy&image_size=portrait_4_3", tips: "观察宝宝饥饿信号", ai_review: "已审核-符合权威喂养指南" },
            { day: "周六", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=feeding%20newborn%20baby%20carefully&image_size=portrait_4_3", tips: "每日喂养8-12次", ai_review: "已审核-符合权威喂养指南" },
            { day: "周日", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20milk%20feeding%20closeup&image_size=portrait_4_3", tips: "记录喂养时间和量", ai_review: "已审核-符合权威喂养指南" }
        ],
        games: [
            { name: "黑白卡追视", desc: "使用黑白对比卡片在宝宝眼前20-30cm处缓慢移动，锻炼视觉追踪能力", tags: ["视觉发育", "蒙台梭利"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=black%20white%20visual%20cards%20baby%20development&image_size=portrait_4_3", steps: ["准备黑白视觉卡", "在宝宝眼前20-30cm处", "缓慢移动卡片", "观察宝宝眼睛跟随"], ai_review: "已审核-符合蒙台梭利视觉训练理念" },
            { name: "轻声说话", desc: "用温柔的声音和宝宝说话、唱歌，促进听觉和语言发育", tags: ["听觉发育", "亲子互动"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=mother%20talking%20softly%20to%20baby&image_size=portrait_4_3", steps: ["贴近宝宝耳朵", "用轻柔语调说话", "唱摇篮曲", "模仿宝宝声音回应"], ai_review: "已审核-符合语言发展理论" },
            { name: "抚触按摩", desc: "每天给宝宝做全身抚触，促进感知觉发育和亲子依恋", tags: ["触觉发育", "安全感"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20massage%20gentle%20touch&image_size=portrait_4_3", steps: ["准备婴儿抚触油", "从头部开始轻柔按摩", "手臂腿部依次进行", "腹部顺时针按摩"], ai_review: "已审核-符合婴幼儿触觉发展指南" },
            { name: "襁褓包裹", desc: "用薄毯轻轻包裹宝宝，模拟子宫环境，给予安全感", tags: ["安全感", "睡眠"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=swaddled%20baby%20peaceful%20sleep&image_size=portrait_4_3", steps: ["准备透气薄毯", "呈菱形铺开", "包裹宝宝身体", "确保松紧适度"], ai_review: "已审核-符合新生儿安全感建立原则" }
        ],
        toys: [
        ...
        books: [
            { name: "《黑白视觉激发卡》", desc: "适合新生儿的高对比度视觉刺激卡片，包含圆点、条纹、几何图形等经典视觉图案", tags: ["视觉", "0岁+"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=black%20white%20baby%20visual%20stimulus%20book&image_size=portrait_4_3", author: "小红花童书", publisher: "青岛出版社", pages: "48页", ai_review: "已审核-符合新生儿视觉发展规律" },
            { name: "《宝宝的第一本书》", desc: "简单的布书，不怕撕咬，触感丰富", tags: ["布书", "触感"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20cloth%20book%20colorful%20soft&image_size=portrait_4_3", author: "婴儿绘本馆", publisher: "中国人口出版社", pages: "12页", ai_review: "已审核-适合0-6个月宝宝" }
        ],
        products: [
    ...
    "1-3": {
        recipes: [
            { day: "周一", meals: "纯母乳喂养或配方奶喂养，可尝试少量维生素D补充剂", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20vitamin%20d%20supplement%20feeding&image_size=portrait_4_3", tips: "每日补充400IU维生素D", ai_review: "已审核-符合权威营养指南" },
            { day: "周二", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20feeding%20breastmilk%20happy&image_size=portrait_4_3", tips: "建立规律喂养时间", ai_review: "已审核-符合权威喂养指南" },
            { day: "周三", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=infant%20bottle%20feeding%20smiling&image_size=portrait_4_3", tips: "喂奶时保持眼神交流", ai_review: "已审核-符合权威喂养指南" },
            { day: "周四", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20feeding%20time%20cozy&image_size=portrait_4_3", tips: "避免边玩边吃", ai_review: "已审核-符合权威喂养指南" },
            { day: "周五", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=mother%20breastfeeding%20happy%20baby&image_size=portrait_4_3", tips: "喂奶后适当活动", ai_review: "已审核-符合权威喂养指南" },
            { day: "周六", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20drinking%20milk%20content&image_size=portrait_4_3", tips: "注意观察尿量", ai_review: "已审核-符合权威喂养指南" },
            { day: "周日", meals: "纯母乳喂养或配方奶喂养", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=feeding%20baby%20natural%20light&image_size=portrait_4_3", tips: "每日奶量500-800ml", ai_review: "已审核-符合权威喂养指南" }
        ],
        games: [
            { name: "被动操", desc: "帮助宝宝活动四肢，促进运动发育，增强肌肉力量", tags: ["运动发育", "蒙台梭利"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20passive%20exercise%20movement&image_size=portrait_4_3", steps: ["让宝宝平躺", "轻柔活动手臂", "活动腿部做蹬腿动作", "按摩背部"], ai_review: "已审核-符合蒙台梭利运动训练理念" },
            { name: "声音追踪", desc: "用摇铃在不同方向发出声音，训练宝宝转头寻找声源", tags: ["听觉", "颈部力量"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20tracking%20sound%20rattle&image_size=portrait_4_3", steps: ["准备摇铃", "在宝宝不同方向摇动", "观察宝宝转头寻找", "每次5-10分钟"], ai_review: "已审核-符合听觉发育理论" },
            { name: "趴着玩", desc: "让宝宝多趴着，锻炼颈部和背部肌肉", tags: ["大运动", "Tummy Time"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20tummy%20time%20playful&image_size=portrait_4_3", steps: ["准备柔软垫子", "让宝宝趴着", "用玩具吸引抬头", "每次3-5分钟"], ai_review: "已审核-符合Tummy Time标准" },
            { name: "表情模仿", desc: "对着宝宝做各种表情，促进社交和情感发育", tags: ["社交", "情感"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=mother%20baby%20face%20expressions%20play&image_size=portrait_4_3", steps: ["近距离与宝宝对视", "做笑脸、鬼脸", "鼓励宝宝模仿", "及时给予回应"], ai_review: "已审核-符合社交情感发展指南" }
        ],
        toys: [
    ...
    "3-6": {
        recipes: [
            { day: "周一", meals: "母乳/配方奶 + 尝试少量高铁米粉（如已准备添加辅食）", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20first%20solid%20food%20rice%20cereal&image_size=portrait_4_3", tips: "从1-2小勺开始尝试", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周二", meals: "母乳/配方奶 + 原味高铁米粉", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20rice%20porridge%20feeding&image_size=portrait_4_3", tips: "调制成稀糊状", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周三", meals: "母乳/配方奶 + 米粉 + 南瓜泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20food%20pumpkin%20puree%20healthy&image_size=portrait_4_3", tips: "南瓜蒸熟后压成泥", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周四", meals: "母乳/配方奶 + 米粉 + 胡萝卜泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20carrot%20puree%20orange%20healthy&image_size=portrait_4_3", tips: "胡萝卜需蒸软烂", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周五", meals: "母乳/配方奶 + 米粉 + 土豆泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20potato%20puree%20creamy%20healthy&image_size=portrait_4_3", tips: "土豆泥可加少量黄油", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周六", meals: "母乳/配方奶 + 米粉 + 苹果泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20apple%20puree%20fresh%20healthy&image_size=portrait_4_3", tips: "选择甜脆苹果", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周日", meals: "母乳/配方奶 + 米粉 + 香蕉泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20banana%20puree%20creamy%20natural&image_size=portrait_4_3", tips: "香蕉本身很甜无需加糖", ai_review: "已审核-符合权威辅食添加指南" }
        ],
        games: [
            { name: "躲猫猫", desc: "用手或毛巾遮住脸再出现，训练客体永久性概念", tags: ["认知", "经典游戏"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=peekaboo%20game%20baby%20laughing&image_size=portrait_4_3", steps: ["用手遮住自己的脸", "突然拿开手说'喵'", "观察宝宝反应", "重复多次"], ai_review: "已审核-符合皮亚杰客体永久性理论" },
            { name: "抓握练习", desc: "把玩具放在宝宝手中，练习抓握和松手", tags: ["精细动作", "手眼协调"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20grasping%20toys%20development&image_size=portrait_4_3", steps: ["准备大小合适的玩具", "放到宝宝手心", "引导宝宝抓握", "鼓励宝宝主动抓取"], ai_review: "已审核-符合精细动作发展指南" },
            { name: "翻身练习", desc: "用玩具引导宝宝翻身，促进大运动发育", tags: ["大运动", "翻身"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20learning%20to%20roll%20over&image_size=portrait_4_3", steps: ["让宝宝侧躺", "用玩具吸引注意力", "引导宝宝翻向另一侧", "及时给予鼓励"], ai_review: "已审核-符合大运动发展里程碑" },
            { name: "镜子游戏", desc: "让宝宝看镜子中的自己，促进自我认知", tags: ["自我认知", "视觉"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20looking%20mirror%20curious&image_size=portrait_4_3", steps: ["准备安全的婴儿镜", "抱着宝宝面对镜子", "指认宝宝五官", "做表情让宝宝模仿"], ai_review: "已审核-符合自我认知发展规律" }
        ],
        toys: [
        ...
        books: [
            { name: "《猜猜我是谁》", desc: "经典洞洞书，互动性强，培养观察力", tags: ["洞洞书", "互动"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=peek%20a%20who%20baby%20book%20colorful&image_size=portrait_4_3", author: "妮娜·兰登", publisher: "明天出版社", pages: "24页", ai_review: "已审核-符合早期阅读发展指南" },
            { name: "《噼里啪啦》系列", desc: "立体翻翻书，帮助养成生活习惯", tags: ["习惯", "立体书"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=pop%20up%20baby%20book%20lifestyle&image_size=portrait_4_3", author: "佐佐木洋子", publisher: "二十一世纪出版社", pages: "20页", ai_review: "已审核-符合生活习惯养成理念" }
        ],
        products: [
    ...
    "6-9": {
        recipes: [
            { day: "周一", meals: "母乳/配方奶 + 米粉 + 南瓜粥 + 蛋黄泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20pumpkin%20porridge%20egg%20yolk%20healthy&image_size=portrait_4_3", tips: "蛋黄从1/4个开始尝试", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周二", meals: "母乳/配方奶 + 面条 + 西兰花泥 + 鸡肉泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20noodles%20broccoli%20chicken%20puree&image_size=portrait_4_3", tips: "面条煮软烂剪碎", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周三", meals: "母乳/配方奶 + 米粉 + 胡萝卜牛肉粥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20beef%20carrot%20porridge%20healthy&image_size=portrait_4_3", tips: "牛肉需去筋膜剁细", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周四", meals: "母乳/配方奶 + 蒸蛋羹 + 土豆泥 + 鳕鱼泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20steamed%20egg%20custard%20cod%20puree&image_size=portrait_4_3", tips: "鳕鱼富含DHA", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周五", meals: "母乳/配方奶 + 小米粥 + 菠菜泥 + 猪肉泥", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20millet%20porridge%20spinach%20pork%20puree&image_size=portrait_4_3", tips: "菠菜焯水后再打泥", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周六", meals: "母乳/配方奶 + 软米饭 + 番茄鸡蛋 + 碎青菜", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20soft%20rice%20tomato%20egg%20healthy&image_size=portrait_4_3", tips: "番茄去皮去籽", ai_review: "已审核-符合权威辅食添加指南" },
            { day: "周日", meals: "母乳/配方奶 + 南瓜饼 + 豆腐泥 + 苹果片", image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20pumpkin%20pancake%20tofu%20puree&image_size=portrait_4_3", tips: "南瓜饼可加少量面粉", ai_review: "已审核-符合权威辅食添加指南" }
        ],
        games: [
            { name: "爬行训练", desc: "用玩具引导宝宝爬行，促进全身运动协调", tags: ["大运动", "爬行"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20learning%20to%20crawl%20playful&image_size=portrait_4_3", steps: ["准备安全的爬行环境", "用玩具吸引宝宝", "在宝宝前方引导", "必要时用手支撑"], ai_review: "已审核-符合大运动发展指南" },
            { name: "玩具传递", desc: "把玩具从一只手传到另一只手，训练双手协调", tags: ["精细动作", "双手协调"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20transferring%20toy%20hand%20coordination&image_size=portrait_4_3", steps: ["给宝宝一个玩具", "引导传到另一只手", "反复练习", "及时表扬"], ai_review: "已审核-符合精细动作发展指南" },
            { name: "指认物品", desc: "指着家中常见物品说出名称，促进语言理解", tags: ["语言", "认知"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=parent%20teaching%20baby%20object%20recognition&image_size=portrait_4_3", steps: ["指着物品说出名称", "重复多次", "引导宝宝眼神跟随", "鼓励宝宝模仿"], ai_review: "已审核-符合语言发展理论" },
            { name: "拍手游戏", desc: "教宝宝拍手，促进模仿能力和社交互动", tags: ["模仿", "社交"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20clapping%20hands%20happy&image_size=portrait_4_3", steps: ["示范拍手动作", "边拍手边说'拍手'", "握住宝宝的手一起拍", "鼓励自主尝试"], ai_review: "已审核-符合社交情感发展指南" }
        ],
        toys: [
        ...
        books: [
            { name: "《我爸爸》《我妈妈》", desc: "温馨的亲情绘本，培养情感认知", tags: ["情感", "家庭"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=my%20dad%20my%20mom%20childrens%20books&image_size=portrait_4_3", author: "安东尼·布朗", publisher: "河北教育出版社", pages: "32页", ai_review: "已审核-符合情感认知发展指南" },
            { name: "《小熊宝宝绘本》", desc: "生活习惯养成系列，简单易懂", tags: ["习惯", "社交"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=little%20bear%20baby%20picture%20books%20series&image_size=portrait_4_3", author: "佐佐木洋子", publisher: "连环画出版社", pages: "24页", ai_review: "已审核-符合生活习惯养成理念" }
        ],
        products: [
    ...
    "9-12": {
        ...
        games: [
            { name: "学走路", desc: "扶着宝宝或让宝宝推推车练习走路", tags: ["大运动", "走路"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20learning%20to%20walk%20holding%20hands&image_size=portrait_4_3", steps: ["宝宝扶着家具站立", "鼓励迈出第一步", "用学步推车辅助", "保持安全环境"] },
            { name: "把玩具放进去", desc: "让宝宝把玩具放进盒子里再倒出来，理解容器概念", tags: ["精细动作", "容器概念"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20putting%20toys%20in%20box%20learning&image_size=portrait_4_3", steps: ["准备盒子和玩具", "示范放入动作", "鼓励宝宝模仿", "表扬完成行为"] },
            { name: "挥手再见", desc: "教宝宝挥手打招呼和再见，促进社交表达", tags: ["社交", "模仿"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20waving%20goodbye%20cute&image_size=portrait_4_3", steps: ["示范挥手动作", "边挥手边说'再见'", "在日常场景练习", "鼓励宝宝主动挥手"] },
            { name: "翻书游戏", desc: "让宝宝自己翻书页，锻炼手指灵活性", tags: ["精细动作", "阅读习惯"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=baby%20turning%20book%20pages%20curious&image_size=portrait_4_3", steps: ["准备纸板书", "示范翻页动作", "鼓励宝宝自己翻", "讲述简单故事"] }
        ],
        toys: [
        ...
        books: [
            { name: "《好饿的毛毛虫》", desc: "经典启蒙绘本，认知星期、水果和数字", tags: ["经典", "认知"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=very%20hungry%20caterpillar%20classic%20book&image_size=portrait_4_3", author: "艾瑞·卡尔", publisher: "明天出版社", pages: "40页", ai_review: "已审核-符合早期阅读发展指南" },
            { name: "《大卫不可以》", desc: "行为规范绘本，教会宝宝什么能做什么不能做", tags: ["行为", "规则"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=david%20no%20childrens%20book%20colorful&image_size=portrait_4_3", author: "大卫·香农", publisher: "河北教育出版社", pages: "32页", ai_review: "已审核-符合行为规范教育理念" }
        ],
        products: [
    ...
    "12-18": {
        ...
        games: [
            { name: "搭积木", desc: "和宝宝一起搭高塔、搭房子，培养空间感和创造力", tags: ["建构", "创造力"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20building%20blocks%20tower%20creative&image_size=portrait_4_3", steps: ["准备积木", "示范搭建", "鼓励宝宝尝试", "一起创造造型"] },
            { name: "模仿做家务", desc: "让宝宝模仿扫地、擦桌子等简单家务，培养责任感", tags: ["生活技能", "模仿"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20pretend%20cleaning%20housework&image_size=portrait_4_3", steps: ["准备儿童清洁工具", "示范做家务", "让宝宝参与", "表扬宝宝劳动"] },
            { name: "指认身体部位", desc: "教宝宝认识眼睛、鼻子、嘴巴等身体部位", tags: ["认知", "自我意识"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=parent%20teaching%20toddler%20body%20parts&image_size=portrait_4_3", steps: ["指着自己的身体部位", "说出名称", "引导宝宝指认", "唱身体部位儿歌"] },
            { name: "扔球捡球", desc: "和宝宝玩扔球捡球游戏，锻炼运动协调和社交互动", tags: ["大运动", "亲子互动"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20throwing%20ball%20game%20playful&image_size=portrait_4_3", steps: ["准备软球", "示范扔球", "鼓励宝宝捡球", "互动玩耍"] }
        ],
        toys: [
        ...
        books: [
            { name: "《小鸡球球》系列", desc: "温馨的成长绘本，充满爱与关怀", tags: ["成长", "情感"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=chick%20ball%20picture%20book%20series%20cute&image_size=portrait_4_3", author: "入山智", publisher: "心喜阅童书", pages: "32页", ai_review: "已审核-符合情感认知发展指南" },
            { name: "《猜猜我有多爱你》", desc: "表达爱的经典绘本，亲子共读首选", tags: ["情感", "亲子"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=guess%20how%20much%20i%20love%20you%20book&image_size=portrait_4_3", author: "山姆·麦克布雷尼", publisher: "明天出版社", pages: "32页", ai_review: "已审核-符合亲子情感培养理念" }
        ],
        products: [
    ...
    "18-24": {
        ...
        games: [
            { name: "分类游戏", desc: "让宝宝按颜色、形状分类玩具或物品，培养逻辑思维", tags: ["认知", "逻辑思维"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20sorting%20toys%20color%20shape&image_size=portrait_4_3", steps: ["准备不同颜色形状的物品", "示范分类", "让宝宝尝试", "纠正和鼓励"] },
            { name: "唱儿歌跳舞", desc: "一起唱儿歌做动作，培养节奏感和运动能力", tags: ["音乐", "运动"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20singing%20dancing%20happy&image_size=portrait_4_3", steps: ["播放儿歌", "示范动作", "鼓励宝宝跟随", "享受音乐乐趣"] },
            { name: "玩沙玩水", desc: "让宝宝玩沙玩水，感受不同材质，激发探索欲", tags: ["感官", "探索"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20playing%20sand%20water%20outdoor&image_size=portrait_4_3", steps: ["准备沙水玩具", "带宝宝到户外", "让宝宝自由探索", "注意安全"] },
            { name: "简单拼图", desc: "8-12片拼图，培养解决问题能力", tags: ["专注力", "问题解决"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=toddler%20puzzle%208%2012%20pieces%20focused&image_size=portrait_4_3", steps: ["准备适合的拼图", "引导观察图案", "鼓励尝试拼合", "表扬完成"] }
        ],
        toys: [
        ...
        books: [
            { name: "《小猪佩奇》系列", desc: "贴近生活的动画绘本，宝宝最爱", tags: ["生活", "社交"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=peppa%20pig%20childrens%20books%20series&image_size=portrait_4_3", author: "英国快乐瓢虫出版公司", publisher: "安徽少年儿童出版社", pages: "32页", ai_review: "已审核-符合社交认知发展指南" },
            { name: "《青蛙弗洛格》系列", desc: "心理成长绘本，帮助宝宝理解情绪", tags: ["心理", "成长"], image: "https://copilot-cn.bytedance.net/api/ide/v1/text_to_image?prompt=frog%20frog%20picture%20book%20series&image_size=portrait_4_3", author: "马克斯·维尔修思", publisher: "湖南少年儿童出版社", pages: "24页", ai_review: "已审核-符合情绪认知发展理念" }
        ],
        products: [
